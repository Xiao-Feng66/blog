...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex w-60 border-r border-border dark:border-border-dark min-h-screen p-5 flex-col bg-card dark:bg-card-dark">
      ...
      <Link
        href="/"
        className="flex items-center gap-3 px-3 py-2.5 text-sm text-muted dark:text-muted-dark hover:text-stone-700 dark:hover:text-stone-300 transition-colors rounded-xl hover:bg-stone-50 dark:hover:bg-stone-800"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
